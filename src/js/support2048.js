define(function(require, exports, module) {
    ...
    exports.getPosTop = function( i , j ){
        return 10 + i*70;
    };

    exports.getPosLeft =  function( i , j ){
        return 10 + j*70;
    };
    ...
    exports.getNumberText = function( number ){
        switch( number ){
    ...
    exports.getFontSize = function(text) {
        switch(text.length) {
            case 1: return '30px';break;
            case 2: return '20px';break;
            case 3: return '14px';break;
            case 4: return '18px';break;
            case 5: return '14px';break;
        }
        return '14px';
    };
